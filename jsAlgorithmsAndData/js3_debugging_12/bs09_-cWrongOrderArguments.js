...
Your code should use the correct order of the arguments for the raiseToPower function call.Your code should fix the variable power so it equals 2 raised to the 3rd power, not 3 raised to the 2nd power.
